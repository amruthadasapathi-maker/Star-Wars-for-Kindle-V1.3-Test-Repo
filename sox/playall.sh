...
MUSICDIR=/mnt/us/documents/StarWars/music
...
export LD_LIBRARY_PATH=/mnt/us/documents/StarWars/sox/library:$LD_LIBRARY_PATH
...
which aplay>/dev/null && aplay /mnt/us/documents/StarWars/sox/silence.wav 2>/dev/null &&  driver="alsa"
...
case "$driver" in
     ...
     /mnt/us/documents/StarWars/sox/sox /var/tmp/playlist.m3u -t wav - trim $offset | aplay&
     ;;
     ...
     /mnt/us/documents/StarWars/sox/soxi "$filename" >/var/tmp/soxidata.txt
     ...
     /mnt/us/documents/StarWars/sox/sox /var/tmp/playlist.m3u -t raw - trim $offset |  /usr/bin/gst-launch \
